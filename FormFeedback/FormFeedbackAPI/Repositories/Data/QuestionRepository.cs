...
namespace FormFeedbackAPI.Repositories.Data
{
    ...
    public class QuestionRepository : GeneralRepository<Question>
    {
        ...
        //public IEnumerable<QuestionVM> GetId(int id)
        //{
        //    var query = "SP_GetQuest";
        //    parameters.Add("qId", id);
        //    var getall = _connectionString.Connection.Query<QuestionVM>(query, parameters, commandType: System.Data.CommandType.StoredProcedure);
        //    return getall;
        //}


        public IEnumerable<QuestionVM> GetQuestOpt()
        {
            var query = "SP_GetQuest";
            var getall = _connectionString.Connection.Query<QuestionVM>(query, parameters, commandType: System.Data.CommandType.StoredProcedure);
            return getall;
        ...
        public IEnumerable<QuestionVM> GetQuest(int id)
        {
            var query = "SP_GetQuestOpt";
